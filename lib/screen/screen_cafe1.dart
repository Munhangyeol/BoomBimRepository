...
class Cafe1Screen extends StatefulWidget{
  @override
  _Cafe1ScreenState createState()=>_Cafe1ScreenState();
}
class _Cafe1ScreenState extends State<Cafe1Screen>{
  @override
            ...
            children: [
              ...
              child:Row(
                ...
                children: [
                  ...
                  child:Image.asset('assets/images/cafe1.png',
                  ...
                  Column(
                  children:[
                    Text('Cafe_01',style: TextStyle(
                    fontFamily: 'IBM',fontSize: 20
                  ),

                  ),
                    Text('가로수길',style: TextStyle(
